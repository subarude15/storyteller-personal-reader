...
#if os(iOS)
private struct InkAmpPortableBackupPayload: Codable {
    ...
    var bookFormatLinkCache: [String: String]
}

private struct InkAmpEncryptedBackupEnvelope: Codable {
    var format: String
    var schemaVersion: Int
    var kdf: String
    var iterations: Int
...
private struct InkAmpBackupDocument: FileDocument {
...
private struct InkAmpBackupView: View {
