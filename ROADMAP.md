...
- [x] **SponsorBlock-style skip (in-app YouTube)** — tip `c38b1e4` / feat `2687e9e`; Josh confirmed auto-skip working
- [x] **Podcast cross-device sync (subs + playheads)** — tip `51563cd`; Storyteller blob `.inkamp.podcastSync.v1`; LWW subscriptions + episode playheads; downloads stay per-device; Settings last-sync / Offline
