...
2. **LazyLibrarian request integration** — in review. Select a book, then **Request** Ebook, Audiobook, or Both. The app resolves that work in the user's LazyLibrarian and queues it. LazyLibrarian searches and downloads. This does **not** mean the file is in the Storyteller library yet, and it does not complete torrent or debrid phases.
